...
const sumaryDates = generateDateRange();

const minimumDaysLength = 18 * 7 // 18 weeks
const amountOfDaysToFill = minimumDaysLength - sumaryDates.length
